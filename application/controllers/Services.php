...
class Services extends CI_Controller
{
    ...
    public function ubah($id)
    {
        ...
        $data['driverjob'] = $this->service->getAlldriverjob();
        $data['wilayah'] = $this->service->getwilayah();
        $cw = $this->service->choosenwilayah($id);
        $arrcw = explode(',', $cw->wilayah);
        $data['choosenwilayah'] = $arrcw;
