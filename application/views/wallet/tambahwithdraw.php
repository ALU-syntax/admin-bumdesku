                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" pattern="^\d+(\,|\.)\d{2}$" data-type="currency" class="form-control" id="saldo" name="saldo" placeholder="masukan jumlah">
                                </div>

                                <div class="form-group">
                                    <label for="bank">Nama Bank</label>
                                    <input type="text" class="form-control" id="bank" name="bank" placeholder="masukan nama bank">
                                </div>

                                <div class="form-group">
                                    <label for="rekening">Nomor rekening</label>
                                    <input type="text" class="form-control" id="rekening" name="rekening" placeholder="masukan rekening bank">
                                </div>

                                <div class="form-group">
                                    <label for="nama_pemilik">Nama</label>
                                    <input type="text" class="form-control" id="nama_pemilik" name="nama_pemilik" placeholder="nama pemilik rekening">
                                </div>
