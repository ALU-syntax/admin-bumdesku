                    ...
                    <div class="card-body">
                                                ...
                                                foreach ($mitra as $mtr) {
                                                    if ($mtr['status_mitra'] == 0) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img class="round" style="width: 40px; height: 40px;" src="<?= base_url('images/merchant/') . $mtr['foto_merchant']; ?>">
                                                            </td>
                                                            <td><?= $mtr['fitur'] ?></td>
                        ...
                        <div id="isiform" style="display:none;">
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2 js-example-basic-single fiturService" style="width:100%" name="id_fitur">
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2 js-example-basic-single" name="category_merchant" style="width:100%">
