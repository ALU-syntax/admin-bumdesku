                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select class="select2 js-example-basic-single" style="width:100%" name="id_kategori">
                      ...
                      <div class="form-group">
                        ...
                        <select class="select2 js-example-basic-single" style="width:100%" name="status_berita">
