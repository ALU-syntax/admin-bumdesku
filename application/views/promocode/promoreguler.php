        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Proses Tambah Saldo Driver Program Promo Reguler</h5>
...
<script>
    ...
    function action_topromo() {
        ...
        $.ajax({
            url : "<?php echo base_url();?>Promocode/reguler_promo_list",
            type : "POST",
            dataType :"JSON",
            data : {sdate:sdate},
    ...
    function promoreguler_isexist() {
        var sdate = $("#start_date_modal").val();
        $.ajax({
            url : "<?php echo base_url();?>Promocode/promoreguler_isexist",
            type : "POST",
            dataType :"JSON",
            data : {sdate:sdate},
            success : function(data) {
                if(data == 1){
                    alert("Promo Reguler Pada Tanggal Ini sudah pernah diproses....!");
                }else{
                    action_topromo();
                }
            }
    ...
    $("#btn_filter").click(function(){
        ...
        if(start_date == '') {
            ...
            window.location = "<?php echo base_url()?>Promocode/reguler_index/"+start_date;
        }
